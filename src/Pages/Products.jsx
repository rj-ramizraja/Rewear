        ...
        <div className="row g-3">
          <div className="col-lg-2">
            <div className="card active">
              ...
              <div className="card-body px-0 pb-0 text-center">
                <h5 className="card-title">Kulangot</h5>
                <p className="card-text">Salt</p>
                <h4>$67.00</h4>
                {/* <Link to="/" className="btn btn-dark w-100">
                  Add to basket
                </Link> */}
                <Link to="/" className="btn btn-dark text-muted bg-light border-0 w-100">
                  Remove from Bucket
                </Link>
              </div>
            </div>
          ...
          <div className="col-lg-2">
            <div className="card">
              ...
              <div className="card-body px-0 pb-0 text-center">
                <h5 className="card-title">Tiktilaok Manok</h5>
                <p className="card-text">Sexbomb</p>
                <h4>$$78.00</h4>
                <Link to="/" className="btn btn-dark w-100">
                  Add to basket
                </Link>
          ...
          <div className="col-lg-2">
            <div className="card">
              ...
              <div className="card-body px-0 pb-0 text-center">
                <h5 className="card-title">Very Nice</h5>
                <p className="card-text">Salt maalat</p>
                <h4>$79.00</h4>
                <Link to="/" className="btn btn-dark w-100">
                  Add to basket
                </Link>
          ...
          <div className="col-lg-2">
            <div className="card">
              ...
              <div className="card-body px-0 pb-0 text-center">
                <h5 className="card-title">Quake Overload</h5>
                <p className="card-text">Yezyow</p>
                <h4>$$80.00</h4>
                <Link to="/" className="btn btn-dark w-100">
                  Add to basket
                </Link>
          ...
          <div className="col-lg-2">
            ...
            <div className="card-img position-relative">
              ...
              <div className="card-body px-0 pb-0 text-center">
                <h5 className="card-title">Kutu</h5>
                <p className="card-text">Sexbomb</p>
                <h4>$129.00</h4>
                <Link to="/" className="btn btn-dark w-100">
                  Add to basket
          ...
          <div className="col-lg-2">
            ...
            <div className="card-img position-relative">
              ...
              <div className="card-body px-0 pb-0 text-center">
                <h5 className="card-title">Tuluk</h5>
                <p className="card-text">Black Kibal</p>
                <h4>$$142.00</h4>
                <Link to="/" className="btn btn-dark w-100">
                  Add to basket
                </Link>
          ...
          <div className="col-lg-2">
            ...
            <div className="card-img position-relative">
              ...
              <div className="card-body px-0 pb-0 text-center">
                <h5 className="card-title">Balakubak</h5>
                <p className="card-text">Betsin Maalat</p>
                <h4>$$170.00</h4>
                <Link to="/" className="btn btn-dark w-100">
                  Add to basket
                </Link>
          ...
          <div className="col-lg-2">
            ...
            <div className="card-img position-relative">
              ...
              <div className="card-body px-0 pb-0 text-center">
                <h5 className="card-title">Pitaklan</h5>
                <p className="card-text">Black Kibal</p>
                <h4>$174.00</h4>
                <Link to="/" className="btn btn-dark w-100">
                  Add to basket
          ...
          <div className="col-lg-2">
            ...
            <div className="card-img position-relative">
              ...
              <div className="card-body px-0 pb-0 text-center">
                <h5 className="card-title">Burnikk</h5>
                <p className="card-text">Sexbomb</p>
                <h4>$240.00</h4>
                <Link to="/" className="btn btn-dark w-100">
                  Add to basket
          ...
          <div className="col-lg-2">
            ...
            <div className="card-img position-relative">
              ...
              <div className="card-body px-0 pb-0 text-center">
                <h5 className="card-title">Sipon Malapot</h5>
                <p className="card-text">salt</p>
                <h4>$250.00</h4>
                <Link to="/" className="btn btn-dark w-100">
                  Add to basket
          ...
          <div className="col-lg-2">
            ...
            <div className="card-img position-relative">
              ...
              <div className="card-body px-0 pb-0 text-center">
                <h5 className="card-title">Buldit</h5>
                <p className="card-text">Salt Maalat</p>
                <h4>$250.00</h4>
                <Link to="/" className="btn btn-dark w-100">
                  Add to basket
